...
def update_requirements(filepath):
    ...
    # The dependencies to ensure exist
    deps_to_add = [
        "aiosmtplib==3.0.1",
        "alembic==1.13.3",
        "asyncpg==0.29.0",
    ...
    # Also make sure we remove the older prometheus-client>=0.17.0 if present to avoid conflicts
...
def fix_imports():
    ...
    with open(fpath, 'r', encoding='utf-8') as f:
        content = f.read()
    # The file has: `from ws_channels import ChannelType, EventType, is_valid_channel`
...
fix_imports()
print("Done fixing requirements and imports.")
