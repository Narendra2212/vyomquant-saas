...
async def main():
    ...
    print("Generating strategy signal...")
    print("Trace: Signal -> BotRunner -> ExecutionEngine -> ExchangeExecutor -> CCXT -> Exchange")
    ...
    try:
        ...
        print("\nExecution Result:", result.get('status'))
        print("Trade Result:", result.get('result', {}))
        
        if mock_ccxt.create_order.called or mock_ccxt.create_market_buy_order.called or mock_ccxt.create_market_order.called:
            print("\nProve ccxt.create_order() is actually called: YES")
            print("Output: PASS")
        else:
            print("\nProve ccxt.create_order() is actually called: NO")
            print("Output: FAIL")
