...
def mock_signal_service():
    ...
    # Simulate service.get_signal(user_id, signal_id)
    async def mock_get_signal(user_id, signal_id):
    ...
    # Simulate service.get_signal_timeline(user_id, signal_id)
    async def mock_get_signal_timeline(user_id, signal_id):
        if user_id == "usr_tenant_a_123" and signal_id == "sig_test_999":
            return [
...
class TestSignalTraceTenantIsolation:
    ...
    def test_get_signal_owner_can_access(self, mock_get_service, user_a, mock_signal_service):
        ...
        try:
            ...
            # Verify service was called with correct user_id
            mock_signal_service.get_signal.assert_called_once_with(user_a["id"], "sig_test_999")
